...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow): #Application Interface
        ...
        self.plainTextEdit.setGeometry(QtCore.QRect(10, 30, 761, 241))
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.resultsField = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.resultsField.setReadOnly(True)
        self.resultsField.setGeometry(QtCore.QRect(10, 310, 761, 241))
        ...
        font.setWeight(50)
        self.algorithmlbl = QtWidgets.QLabel(self.centralwidget)
        self.algorithmlbl.setGeometry(QtCore.QRect(10, 5, 71, 21))
        self.algorithmlbl.setFont(font)
        self.algorithmlbl.setObjectName("algorithmlbl")
        self.resultslbl = QtWidgets.QLabel(self.centralwidget)
        self.resultslbl.setGeometry(QtCore.QRect(10, 280, 71, 31))
        self.resultslbl.setFont(font)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.algorithmlbl.setText(_translate("MainWindow", "Algorithm:"))
        self.resultslbl.setText(_translate("MainWindow", "Results:"))
        ...
        self.resultsField.setPlaceholderText("Your results will be shown in here...")
